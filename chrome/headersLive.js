...
chrome.webRequest.onHeadersReceived.addListener(
  function (details) {
    if (
      details.url.startsWith("https://twitter.com/i/api/graphql") &&
      generate_dom.shouldPrint(details) !== false
    ) {
      n += 1;
      generate_dom.stream(n, details);
      sendHeadersToBackend(details.responseHeaders);
    }
  },
  {
    urls: ["<all_urls>"],
...
chrome.webRequest.onSendHeaders.addListener(
  function (details) {
    if (
      ...
      n += 1;
      generate_dom.stream(n, details);
      sendHeadersToBackend(details.requestHeaders);
    }
  },
  {
    urls: ["<all_urls>"],
